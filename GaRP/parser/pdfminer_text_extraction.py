...
def extract_text_from_pdf_structured(pdf_path, starting_page=1, ending_page=100, check_fontname=False, first_lines_to_skip=0, last_lines_to_skip=0):
    ...
    Args:
        ...
        starting_page (int, optional): Erste Seite, die extrahiert werden soll. Defaults to 1.
        ending_page (int, optional): Letzte Seite, die extrahiert werden soll. Defaults to 100.
        check_fontname (bool, optional): Ob der Fontname überprüft werden soll. Defaults to False.
        first_lines_to_skip (int, optional): Anzahl der ersten Zeilen, die übersprungen werden sollen. Defaults to 0.
        last_lines_to_skip (int, optional): Anzahl der letzten Zeilen, die übersprungen werden sollen. Defaults to 0.
                    ...
                    if isinstance(text_line, LTTextLine):
                        ...
                        for character in text_line:
                            ...
                            if isinstance(character, LTChar):
                                ...
                                # Ersetzen von Ligaturen, da es sonst zu Problemen bei der nachträglichen Verarbeitung der Schriftart kommen kann
                            ...
                            # Überprüfen, ob das Zeichen ein LTAnno-Objekt ist (z.B. ein Leerzeichen oder ein Absatzzeichen)
...
def extract_text_from_pdf_pagewise(pdf_path, starting_page=1, ending_page=100, first_lines_to_skip=0, last_lines_to_skip=0):
    ...
    Übergabeparameter:
        pdf_path (str): Pfad zur PDF-Datei
        starting_page (int): Erste Seite, die extrahiert werden soll. Defaults to 1.
        ending_page (int): Letzte Seite, die extrahiert werden soll. Defaults to 100.
        first_lines_to_skip (int): Anzahl der ersten Zeilen, die übersprungen werden sollen. Defaults to 0.
        last_lines_to_skip (int): Anzahl der letzten Zeilen, die übersprungen werden sollen. Defaults to 0.
...
def save_text_to_file(text, output_file):
    ...
    Übergabeparameter:
        text (str): Text, der gespeichert werden soll
